    ...
    <div class="p-3 bg-gray-100 rounded-lg">
      <form @submit.prevent="handleSubmit">
        <div class="grid gap-6 mb-6 md:grid-cols-2">
          <div>
            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
              First name
            </label>
          ...
          <div>
            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
              Last name
            </label>
          ...
          <div>
            <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
              Phone number
            </label>
          ...
          <div>
            <label for="website" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
              Website URL
            </label>
          ...
          <div>
            <label for="City" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
              City
            </label>
